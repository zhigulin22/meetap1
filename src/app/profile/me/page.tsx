  ...
  return (
    <PageShell>
          ...
          <div className="rounded-2xl border border-border bg-[rgb(var(--surface-1-rgb)/0.74)] p-3">
            ...
            <div className="mt-2 h-2 rounded-full bg-surface2/72">
              <motion.div
                ...
                className="h-2 rounded-full bg-[linear-gradient(90deg,var(--blue),var(--mint))]"
              />
            </div>
              ...
              {qualityItems.map((item) => (
                <div
                  ...
                  className={`inline-flex items-center gap-2 rounded-xl border px-2.5 py-2 text-xs ${
                    item.done
                      ? "border-mint/40 bg-mint/12 text-mint/90"
                      : "border-border bg-surface2/56 text-text2"
                  }`}
                >
      ...
      {!psychCompleted && showPsychCard ? (
        <Card className="mb-3 border-blue/35 bg-[linear-gradient(120deg,rgb(var(--blue-rgb)/0.16),rgb(var(--mint-rgb)/0.14))]">
          <CardContent className="space-y-3 p-4">
      ...
      {canOpenAdmin ? (
        <Card className="mb-3 border-blue/35 bg-blue/11">
        ...
        <Card className="mb-3 border-blue/28 bg-blue/8">
          <CardContent className="space-y-3 p-4">
            <div>
